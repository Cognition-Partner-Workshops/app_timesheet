    ...
    <footer className="bg-[#1a1a1a] text-white">
      <div className="max-w-[1200px] mx-auto px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Social */}
          <div>
            <h3 className="text-[14px] font-bold mb-4 text-white">تابعنا على</h3>
            <div className="flex gap-2.5">
              {[
                ...
                <a key={s.label} href={s.href} aria-label={s.label} className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#0a5c36] transition-colors">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path d={s.icon} /></svg>
                </a>
              ))}
            </div>
          </div>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-[14px] font-bold mb-4 text-white">تواصل معنا</h3>
          ...
          {/* Apps */}
          <div>
            <h3 className="text-[14px] font-bold mb-4 text-white">تطبيقات الجامعة</h3>
            <ul className="space-y-2.5">
              {[
          ...
          {/* Links */}
          <div>
            <h3 className="text-[14px] font-bold mb-4 text-white">روابط مهمة</h3>
            <ul className="space-y-2.5">
              <li><Link to="/regulations" className="text-[13px] text-gray-400 hover:text-white transition-colors">اللوائح والأنظمة</Link></li>
              {[
      ...
      <div className="border-t border-white/10">
        <div className="max-w-[1200px] mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-[12px] text-gray-500">جميع الحقوق محفوظة لجامعة الملك سعود © {new Date().getFullYear()}</p>
          <div className="flex gap-4">
            {[
              ...
              <a key={l.label} href={l.href} className="text-[12px] text-gray-500 hover:text-white transition-colors">{l.label}</a>
            ))}
          </div>
        </div>
      </div>
