...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects', async () => {
      const mockProjects = [
        ...
        { id: 2, name: 'Project B', description: 'Desc B', client_id: null, client_name: null, start_date: null, status: 'on-hold', created_at: '2024-01-02', updated_at: '2024-01-02' }
      ];
  ...
  describe('POST /api/projects', () => {
    test('should create new project with all fields', async () => {
      const newProject = { name: 'New Project', description: 'New Desc', clientId: 1, startDate: '2024-06-01', status: 'active' };
      const createdProject = { id: 1, name: 'New Project', description: 'New Desc', client_id: 1, client_name: 'Client A', start_date: '2024-06-01', status: 'active', created_at: '2024-01-01', updated_at: '2024-01-01' };

      // First get: client exists check
    ...
    test('should create project with only required fields', async () => {
      ...
      const createdProject = { id: 1, name: 'Minimal Project', description: null, client_id: null, client_name: null, start_date: null, status: 'active' };
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should handle database error when checking client existence during update', async () => {
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 }); // Project exists
      });
