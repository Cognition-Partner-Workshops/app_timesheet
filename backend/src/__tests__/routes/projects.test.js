...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        { id: 1, name: 'Project A', description: 'Desc A', client_id: 1, start_date: '2024-01-01', status: 'in_progress', created_at: '2024-01-01', updated_at: '2024-01-01', client_name: 'Client A' },
    ...
    test('should filter by status', async () => {
      ...
      const response = await request(app).get('/api/projects?status=in_progress');

      expect(response.status).toBe(200);
      expect(mockDb.all).toHaveBeenCalledWith(
        expect.stringContaining('AND p.status = ?'),
        ['test@example.com', 'in_progress'],
        expect.any(Function)
      );
    });
  ...
  describe('GET /api/projects/:id', () => {
    test('should return specific project', async () => {
      const mockProject = { id: 1, name: 'Project A', description: 'Desc A', client_id: 1, start_date: '2024-01-01', status: 'in_progress', client_name: 'Client A' };
  ...
  describe('POST /api/projects', () => {
    test('should create project with valid data', async () => {
      const newProject = { name: 'New Project', description: 'New Description', status: 'in_progress' };
    ...
    test('should create project without optional fields', async () => {
      ...
      const createdProject = { id: 1, name: 'Minimal Project', description: null, client_id: null, start_date: null, status: 'in_progress' };
    ...
    test('should return 400 for invalid status', async () => {
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test', status: 'cancelled' });
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project name', async () => {
      const updatedProject = { id: 1, name: 'Updated Name', description: 'Old Desc', status: 'in_progress' };
    ...
    test('should update multiple fields', async () => {
      const updatedProject = { id: 1, name: 'New Name', description: 'New Description', status: 'on_hold' };
      ...
      const response = await request(app)
        .put('/api/projects/1')
        .send({ name: 'New Name', description: 'New Description', status: 'on_hold' });
